...
export function BrowserMenu({ paneId, onFindToggle, onClipToVault }: Props) {
    ...
    <div className="layout-picker" ref={ref}>
      ...
      {open && (
        <div className="layout-picker__popover browser-menu__popover" role="menu">
          ...
          <button type="button" className="browser-menu__item" role="menuitem" onClick={() => { onClipToVault(); setOpen(false) }}>
